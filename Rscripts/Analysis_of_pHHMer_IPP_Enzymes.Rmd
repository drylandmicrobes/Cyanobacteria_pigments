---
title: "Analysis_of_pHHMer_IPP_Enzymes"
output: pdf_document
---
...
#Habitats: "saltwater"  "symbiont" "freshwater" "cave" 
#"desert" "tropical" "soil" "rock" "hot spring" "temperate"
#######################################################
...
#png("PCA Plot of Carotenoid BLAST Hit .png", width=1000, height=1000)
ggbiplot(pca_phmmer_IPP,labels= rownames(phmmer_IPP),ellipse=FALSE,obs.scale = 3,var.scale = 1, groups=habitat) +
  scale_colour_manual(name="Habitat", values= c("saddlebrown", "darkorange1", "cornflowerblue", "deeppink", "red", "dark blue", "forest green", "gold", "darkmagenta", "black"))+
  ggtitle("PCA of pHMMer IPP Enzymes")+
  theme_minimal()+
  theme(legend.position = "bottom")
...
simp_phmmer_IPP= simper(phmmer_IPP_matrix, group= pHMMER$Habitat)
summary(simp_phmmer_IPP)
